...
<div class="w-full max-w-md bg-white p-8 rounded-lg shadow-md">
    ...
    <form class="mt-6" action="{{ route('login.submit') }}" method="POST">
        <div>
            ...
            <input type="email" placeholder="Masukkan email" class="w-full px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
        </div>
        <div class="mt-4">
            <label class="block text-sm font-medium text-gray-700">Password</label>
            <input type="password" placeholder="Masukkan password" class="w-full px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
        </div>
